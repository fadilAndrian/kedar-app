      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:items-start">
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <!-- form -->
              <div class="mt-6">
                  <input wire:model="role_id" type="hidden">
                  </input>
                <label for="about" class="block text-md font-medium text-gray-700">
                  Role
                </label>
                <div class="mt-1">
                  <input wire:model="role" type="text" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md">
                  </input>
                ...
                <div class="mt-1">
                  <textarea wire:model="keterangan" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md">
                  </textarea>
                </div>
              </div>
            <!-- END FORM -->
