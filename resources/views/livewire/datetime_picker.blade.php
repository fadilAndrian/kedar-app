    ...
    <div class="antialiased sans-serif">
      <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
        <div class="container">
          <div class="mb-5 w-64">
            <div class="relative">
              <input wire:model="deadline" type="date" name="date" x-ref="date" :value="datepickerValue" onchange="this.dispatchEvent(new InputEvent('input'))" autocomplete="off" />
              <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue" x-on:keydown.escape="showDatepicker = false" class="w-full text-gray-600 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Select date" readonly />
