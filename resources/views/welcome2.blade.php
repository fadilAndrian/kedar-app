      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
          <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#">
                ...
                <img class="h-auto w-32 sm:h-auto" src="img/kedarlogo1.png">
              </a>
          ...
          <div class="hidden md:block md:ml-auto md:pr-4 md:space-x-8">
            <a href="#profile" class="font-medium text-gray-500 hover:text-gray-900">Profil</a>
      ...
      <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span class="block xl:inline">Kita lanjutkan raih</span>
            <span class="block text-indigo-600 xl:inline">masa depan</span>
          </h1>
          <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-9 md:text-xl lg:mx-0">
            Mari bergabung dan mulai belajar lagi.
          </p>
...
<!-- feature section -->
<div class="py-12 my-32 bg-white" id="profile">
